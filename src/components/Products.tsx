...
const Products: FC = () => {
  return (
    <div className="flex flex-col items-center justify-center w-full mt-8 lg:mt-10 md:mt-24">
      <div className="mt-10 lg:mt-20 mb-10 lg:mb-20">
        ...
        <div className="flex items-center justify-center w-full mt-4 sm:mt-6 lg:mt-10">
          <div className="flex w-5/6 lg:w-[1100px] justify-center sm:px-10 lg:px-0">
            <div className="flex lg:grid-rows-3 gap-2 sm:gap-4 lg:gap-6">
              ...
              <div className="lg:row-span-2 w-2/5 lg:w-[500px]">
